...
public class AppConfig implements WebMvcConfigurer{
	...
	//this is to inform DispatcherServlet to let go of request that it can handle to
	//the tomcat's default handler.For example, for CSS, JS, Images et
	...
	//Using this bean,mybatis-spring engine creates instance for all
	...
	//overide the default behaviour of InternalResourceViewResolver
